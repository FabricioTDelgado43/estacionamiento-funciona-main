    ...
    return (
        <div>
            <div className="menu">
                {loggedIn && (
                    <>
                        <h1 className='facturando'>Facturando como {currentUser}</h1>
                        <button onClick={logout} className='boton boton-color'>Cerrar Sesión</button>
                    </>
                )}
            </div>
            ...
            {loggedIn && (
                <div>
                    ...
                    <h2 className='vehiculo-medio'>Vehículos</h2>
                        ...
                        {autos
                            ...
                            .map((auto) => (
                                <div key={auto._id} className="auto-card">
                                    ...
                                    {}
                                    <button  className='boton-cobrar' onClick={() => auto.cobrado ? eliminarAuto(auto._id) : cobrar(auto._id, auto.precioPorHora)}>
